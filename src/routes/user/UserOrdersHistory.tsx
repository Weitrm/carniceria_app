        ...
        <header className="flex flex-col gap-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                Consulta tus envios anteriores y su estado. Usa filtros por estado o rango de fechas.
              </p>
            </div>
            <div className="flex flex-col items-end gap-2 text-right">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="rounded-lg border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-semibold text-slate-700 transition hover:border-rose-200 hover:text-rose-700"
                >
                  Limpiar filtros
                </button>
              </div>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-lg border border-emerald-100 bg-emerald-50/70 px-4 py-3 text-sm text-emerald-800">
              ...
              <p className="text-xs">Filtra por pendiente para ver lo que falta entregar.</p>
            </div>
            <div className="rounded-lg border border-slate-100 bg-slate-50 px-4 py-3 text-sm text-slate-800">
              ...
              <p className="text-xs">Acota por dia de creacion para encontrar pedidos rapidos.</p>
            </div>
            <div className="rounded-lg border border-rose-100 bg-rose-50/70 px-4 py-3 text-sm text-rose-800">
              <p className="font-semibold">Navega</p>
              <p className="text-xs">Ve al catalogo o carrito para crear un nuevo pedido.</p>
              <div className="mt-2 flex gap-2">
                <button
                  onClick={() => navigate("/user/products")}
                  className="rounded-md border border-emerald-200 bg-white px-3 py-1 text-[11px] font-semibold text-emerald-700 transition hover:bg-emerald-50"
                >
                  Catalogo
                </button>
                <button
                  onClick={() => navigate("/user/cart")}
                  className="rounded-md border border-slate-200 bg-white px-3 py-1 text-[11px] font-semibold text-slate-700 transition hover:border-rose-200 hover:text-rose-700"
                >
                  Carrito
                </button>
              </div>
